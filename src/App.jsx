...
import { Upload, FileVideo, Loader2, CheckCircle2, Copy, Download, Clock, Globe, ChevronDown, ChevronUp, History, Zap } from "lucide-react";
      ...
      {tab === "transcript" && (
        <div className="content-box">
          <div className="content-actions">
            ...
            <button className="icon-btn" onClick={() => downloadFile(result.transcript, `${baseName}.txt`, "text/plain")} title="Download TXT">
              <Download size={15} />
            </button>
          </div>
      ...
      {tab === "captions" && (
        <div className="content-box">
          <div className="content-actions">
            ...
            <button className="icon-btn" onClick={() => downloadFile(result.srt_captions, `${baseName}.srt`, "text/plain")} title="Download SRT">
              <Download size={15} />
            </button>
          </div>
  ...
  return (
    <div className="app">
      <header className="header">
        ...
        <p className="tagline">Whisper-powered transcription & SRT caption generation</p>
      </header>
      ...
      <main className="main">
        {status === "idle" && (
          ...
          >
            <input ref={inputRef} type="file" hidden accept="video/*,audio/*" onChange={onFileChange} />
      ...
      <footer className="footer">
        Powered by OpenAI Whisper · Results stored in Supabase
      </footer>
    </div>
  );
}
